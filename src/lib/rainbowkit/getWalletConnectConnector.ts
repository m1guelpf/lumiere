...
type WalletConnectConnectorOptions = ConstructorParameters<typeof WalletConnectConnector>[0]
...
export function getWalletConnectConnector({ chains, qrcode = false }: { chains: Chain[]; qrcode?: boolean }) {
